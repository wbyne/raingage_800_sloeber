 ...
 ****************************************************/
//ifndef added after some googling
// don't forget the #endif at the end of the file also.
// For reference, the latest Adafruit_FONA library had this
// correct, but it was ommitted from this earlier version???
// Also, I'm using this version because they removed a function
// or two and then protected the mySerial stream, which Michael
// used to initialize the modem.  It looks like most of the
// functions needed are now provided by the library.  Just
// something else to look at in the future. fwb-30Aug15
...
class Adafruit_FONA : public Stream {
 public:
  ...
  boolean writeSMS(char *smsaddr, char *smsmgs);
